...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_12 = {
	sizeof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_v7xyNonCriticalExtensions_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions, physicalChannelReconfigurationComplete_v7xyext),
	...
	{ ATF_POINTER, 1, offsetof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_v7xyNonCriticalExtensions_specs_10 = {
	sizeof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions),
	offsetof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_8[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions, v7xyNonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
