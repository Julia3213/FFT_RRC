...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_12 = {
	sizeof(struct TransportFormatCombinationControl__laterNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct TransportFormatCombinationControl__laterNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_10[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct TransportFormatCombinationControl__laterNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
