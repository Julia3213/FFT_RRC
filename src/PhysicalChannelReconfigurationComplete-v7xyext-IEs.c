...
asn_TYPE_member_t asn_MBR_PhysicalChannelReconfigurationComplete_v7xyext_IEs_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PhysicalChannelReconfigurationComplete_v7xyext_IEs_specs_1 = {
