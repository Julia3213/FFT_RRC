...
/* Dependencies */
typedef enum MBMS_MICHConfigurationInfo_r7__mode_PR {
	MBMS_MICHConfigurationInfo_r7__mode_PR_NOTHING,	/* No components present */
	MBMS_MICHConfigurationInfo_r7__mode_PR_fdd,
	MBMS_MICHConfigurationInfo_r7__mode_PR_tdd384,
	MBMS_MICHConfigurationInfo_r7__mode_PR_tdd768,
	MBMS_MICHConfigurationInfo_r7__mode_PR_tdd128
} MBMS_MICHConfigurationInfo_r7__mode_PR;
...
typedef struct MBMS_MICHConfigurationInfo_r7 {
	...
	struct MBMS_MICHConfigurationInfo_r7__mode {
		MBMS_MICHConfigurationInfo_r7__mode_PR present;
		union MBMS_MICHConfigurationInfo_r7__mode_u {
			struct MBMS_MICHConfigurationInfo_r7__mode__fdd {
			...
			struct MBMS_MICHConfigurationInfo_r7__mode__tdd384 {
			...
			struct MBMS_MICHConfigurationInfo_r7__mode__tdd768 {
				TimeslotNumber_t	 timeslot;
			...
			struct MBMS_MICHConfigurationInfo_r7__mode__tdd128 {
				TimeslotNumber_LCR_r4_t	 timeslot;
				MidambleShiftAndBurstType_LCR_r4_t	 midambleShiftAndBurstType;
				struct MBMS_MICHConfigurationInfo_r7__mode__tdd128__channelisationCodeList {
...
extern asn_SEQUENCE_specifics_t asn_SPC_MBMS_MICHConfigurationInfo_r7_specs_1;
extern asn_TYPE_member_t asn_MBR_MBMS_MICHConfigurationInfo_r7_1[2];
