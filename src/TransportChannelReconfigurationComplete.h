...
typedef struct TransportChannelReconfigurationComplete {
	...
	struct TransportChannelReconfigurationComplete__laterNonCriticalExtensions {
		...
		struct TransportChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions {
			TransportChannelReconfigurationComplete_v7xyext_IEs_t	 transportChannelReconfigurationComplete_v7xyext;
			struct TransportChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions__nonCriticalExtensions {
