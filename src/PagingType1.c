...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_8 = {
	sizeof(struct PagingType1__laterNonCriticalExtensions__v590NonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct PagingType1__laterNonCriticalExtensions__v590NonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_v590NonCriticalExtensions_6[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PagingType1__laterNonCriticalExtensions__v590NonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
