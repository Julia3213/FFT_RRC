...
static asn_TYPE_member_t asn_MBR_preconfiguration_30[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration, rab_Info),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_RAB_Info_r6,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration, defaultConfigMode),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration, defaultConfigIdentity),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration, rb_InformationChangedList),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration, powerOffsetInfoShort),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_preconfiguration_specs_30 = {
	sizeof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration),
	offsetof(struct RadioBearerSetup_r6_IEs__specificationMode__preconfiguration, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_specificationMode_15[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RadioBearerSetup_r6_IEs__specificationMode, choice.preconfiguration),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
