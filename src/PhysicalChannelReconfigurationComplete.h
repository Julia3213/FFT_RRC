...
typedef struct PhysicalChannelReconfigurationComplete {
	...
	struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions {
		...
		struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions {
			PhysicalChannelReconfigurationComplete_v7xyext_IEs_t	 physicalChannelReconfigurationComplete_v7xyext;
			struct PhysicalChannelReconfigurationComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions__nonCriticalExtensions {
