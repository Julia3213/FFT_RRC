...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_8 = {
	sizeof(struct URAUpdateConfirm_CCCH__r3__laterNonCriticalExtensions__v690NonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct URAUpdateConfirm_CCCH__r3__laterNonCriticalExtensions__v690NonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_v690NonCriticalExtensions_6[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct URAUpdateConfirm_CCCH__r3__laterNonCriticalExtensions__v690NonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
