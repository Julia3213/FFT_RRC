...
static asn_TYPE_member_t asn_MBR_syncCase1_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase__syncCase1, timeslot),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_syncCase1_specs_8 = {
	sizeof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase__syncCase1),
	offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase__syncCase1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_syncCase2_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase__syncCase2, timeslotSync2),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_syncCase2_specs_10 = {
	sizeof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase__syncCase2),
	offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase__syncCase2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_syncCase_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase, choice.syncCase1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_syncCase1_8,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase, choice.syncCase2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_syncCase_specs_7 = {
	sizeof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase),
	offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase, _asn_ctx),
	offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase, present),
	sizeof(((struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384__syncCase *)0)->present),
...
static asn_TYPE_member_t asn_MBR_tdd384_6[] = {
	{ ATF_POINTER, 1, offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384, syncCase),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd384_specs_6 = {
	sizeof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384),
	offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption__tdd384, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tddOption_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PrimaryCCPCH_Info_r4__tdd__tddOption, choice.tdd384),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_tdd384_6,
		0,
