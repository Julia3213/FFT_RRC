...
typedef struct RadioBearerReleaseComplete {
	...
	struct RadioBearerReleaseComplete__laterNonCriticalExtensions {
		...
		struct RadioBearerReleaseComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions {
			RadioBearerReleaseComplete_v7xyext_IEs_t	 radioBearerReleaseComplete_v7xyext;
			struct RadioBearerReleaseComplete__laterNonCriticalExtensions__v7xyNonCriticalExtensions__nonCriticalExtensions {
